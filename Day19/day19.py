...
model = BaggingClassifier(base_estimator=DecisionTreeClassifier(splitter='random'), n_estimators=20, random_state=0).fit(X_train, y_train)

#plt.style.use('dark_background')
#plt.rcParams['text.color'] = 'black'
#fig, ax = plt.subplots(figsize=(10, 10), facecolor='k')
#tree.plot_tree(model, rotate=True, ax=ax);
#plt.show()
